...
public class Main {
	 ...
	 static final String USERNAME     	= "pg1@banglafire.com";
	    static final String PASSWORD     = "emdad123123"+"gOo806VpTRjhlr4ER9SJNqBac";
	    static final String LOGINURL     = "https://login.salesforce.com";
	    static final String GRANTSERVICE = "/services/oauth2/token?grant_type=password";
	    static final String CLIENTID     = "3MVG9d8..z.hDcPLhOY9753jBaQEx0e4ZnDvXMnikShOmf3lFZppdkziW.EUAAu2Y2.MDzm1gnTiN3wJU5iE4";
	    static final String CLIENTSECRET = "7945439251537095277";
	 ...
	 // Create Leads using REST HttpPost
	    public static void createLeads() {
	        ...
	        try {
	            ...
	            lead.put("Company", "banglafire.com");
